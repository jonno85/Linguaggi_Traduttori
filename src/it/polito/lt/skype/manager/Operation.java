...
public class Operation{
	...
	public myVar Soper(myVar a, myVar b, String segno){
		...
		int type = a.getType();
		if(segno.compareTo("+")==0)
			result = new myVar("",type,new String((String)(a.getValue()+(String)(b.getValue()))));	
		return result;
	}
	public myVar Boper(myVar a, myVar b, String segno){
		...
		int type = a.getType();
		if(segno.compareTo("&")==0)
			result = new myVar("",type,new Boolean((Boolean)(a.getValue())&((Boolean)(b.getValue()))));
		if(segno.compareTo("|")==0) 
			result = new myVar("",type,new Boolean((Boolean)(a.getValue())|((Boolean)(b.getValue()))));
		return result;	
	}
	public myVar BNoper(myVar a, String segno){
		int type = a.getType();
		if(segno.compareTo("!")==0) 
			result = new myVar("",type,new Boolean(!((Boolean)(a.getValue()))));
		return result;	
	}
